...
namespace NMT.Controllers
{
    public class QuestionTypeController : Controller
    {
        ...
        public QuestionTypeController(DbNMTContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description")] QuestionType questionType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description")] QuestionType questionType)
        {
